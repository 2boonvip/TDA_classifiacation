...
#モデル作成
input = Input(shape=(300, 1)) # 384dim
x = create_single_module(input, 60) # 30->28 dim
x = MaxPool1D(5)(x) # 28 -> 14dim
...
history = model.fit(X_train, y_train, batch_size=32, epochs=100, validation_data=(X_train, y_train)).history
